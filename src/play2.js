...
export default function Play(ctx) {
  ...
  this.init = ({ generate }) => {
    ...
    tiles = new QuadList(bs.x, bs.y, bs.w, bs.h, 6);

    tiles.insertWithRectangle(rect(bs.x + 200, bs.y + 200, 
                                   100, 100),
                              stateHidden);
    tiles.deleteWithRectangle(rect(bs.x + 200, bs.y + 200,
                                   100, 50),
                              stateHidden);
  };
